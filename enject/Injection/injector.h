...
void Enject(LPCSTR window_class_name, LPCWSTR dll_path)
{
	...
	cout << xor_a("[+] Process ID found on 0x") << hex << ProcID << endl;
	cout << xor_a("[+] Thread ID found on 0x") << hex << ThreadID << endl;
	...
	{		
		...
		cout << xor_a("[+] Base Address found on 0x") << hex << BaseAddress << endl;
		...
		printf(xor_a("[+] Relocated Image Successfully\n"));
